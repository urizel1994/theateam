...
addListener('click', document.querySelector('button'), fn);
addListener('click', document.querySelector('#blank'), fn);
...
removeListener('click', document.querySelector('#blank'), fn);
...
emulateClick(document.querySelector('button'));
...
function once(target, fn) {
    target.addEventListener('click', function f(e) {
         fn();
         e.target.removeEventListener('click', f)
    })
}
